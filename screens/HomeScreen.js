...
import {
  PossibleAnswer
} from "../components/PossibleAnswer";
...
export default function HomeScreen() {
  return ( <
    ...
    View >
    <
    PossibleAnswer text = 'Raudonas automobilisRaudonas automobilisRaudonas automobilisRaudonas automobilisRaudonas automobilisf'
    isCorrect = {
      true
    }
    /> <
